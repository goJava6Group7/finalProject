...
public class DaoHotel implements Dao<Hotel> {
    ...
    public boolean delete(Hotel hotel) {
        ...
        if (optional.isPresent()) {
            ...
            DataBaseManagerFactory.getDataBaseManager().getDaoRoom().deleteRoomsByHotelId(idList);
            DataBaseManagerFactory.getDataBaseManager().getDaoReservation().deleteReservationsByHotelId(idList);
            return true;
        }
        return false;
    }
